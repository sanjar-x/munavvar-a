...
- [x] 01-02-PLAN.md -- Warehouse pickup test (TEST-02) + walk-in sale test (TEST-03)
- [x] 01-03-PLAN.md -- Courier shift close test (TEST-04)
...
- [x] 02-02-PLAN.md -- Enum fixes + Alembic migration rebuild (DB-01, DB-02)
