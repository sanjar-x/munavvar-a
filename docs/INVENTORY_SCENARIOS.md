...
- [Inventory Scenarios \& Edge Cases: HOD Water Delivery](#inventory-scenarios--edge-cases-hod-water-delivery)
  ...
  - [3. Warehouse Operations](#3-warehouse-operations)
    ...
    - [4.3 Evening: Close Shift (COURIER_RETURN + Cash Collection)](#43-evening-close-shift-courier_return--cash-collection)
    - [4.4 Loss Write-Off (LOSS_WRITE_OFF)](#44-loss-write-off-loss_write_off)
...
_Generated from codebase analysis on 2026-03-27. Covers all modules: inventory, orders, finances, catalog, users._
